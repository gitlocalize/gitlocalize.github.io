            ...
            <main>
                ...
                <div className="selection features">
                    ...
                    <div className="repository">
                        <div className="repository__side">
                            <div className="repository__img-container">
                                <div className="repository__img"/>
                            </div>
                        </div>
                        <div className="repository__side repository__sync">
                ...
                <div className="selection advantages">
            ...
            <footer className="footer">
                <div className="footer__row">
                    <div className="footer__side">
                        <div className="footer__column footer__logo2">
